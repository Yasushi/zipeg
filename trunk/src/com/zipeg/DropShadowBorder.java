...
public class DropShadowBorder implements Border {
    private static final Integer TOP = new Integer(0),
            TOP_LEFT = new Integer(1), LEFT = new Integer(2),
            BOTTOM_LEFT = new Integer(3),
            BOTTOM = new Integer(4), BOTTOM_RIGHT = new Integer(5),
            RIGHT = new Integer(6), TOP_RIGHT = new Integer(7);
    ...
    public void paintBorder(Component c, Graphics graphics, int x, int y, int width, int height) {
        ...
        if (showLeftShadow) {
            ...
            g2.drawImage((Image)images.get(LEFT),
        ...
        if (showBottomShadow) {
            Rectangle bottomShadowRect =
                new Rectangle(bottomLeftShadowPoint.x + shadowSize,
                              ...
                              shadowSize);
            g2.drawImage((Image)images.get(BOTTOM),
        ...
        if (showRightShadow) {
            ...
            g2.drawImage((Image)images.get(RIGHT),
    ...
    private Map getImages() {
        ...
        Map images = (Map)CACHE.get(new Integer(shadowSize));
        if (images == null) {
            images = new HashMap();
             ...
             */
            int rw = cornerSize + 1;
            RoundRectangle2D rect = new RoundRectangle2D.Double(0, 0, rw, rw, cornerSize, cornerSize);
            int n = rw + shadowSize * 2;
            ...
            BufferedImage targetImage = new BufferedImage(n, n, BufferedImage.TYPE_INT_ARGB);
            ...
            int w = shadowSize;
            int h = shadowSize;
            images.put(TOP_LEFT, getSubImage(targetImage, x, y, w, h));
            x = 1;
            y = h;
            w = shadowSize;
            h = 1;
            images.put(LEFT, getSubImage(targetImage, x, y, w, h));
            x = 1;
            y = rw;
            w = shadowSize;
            h = shadowSize;
            images.put(BOTTOM_LEFT, getSubImage(targetImage, x, y, w, h));
            x = cornerSize + 1;
            y = rw;
            w = 1;
            h = shadowSize;
            images.put(BOTTOM, getSubImage(targetImage, x, y, w, h));
            x = rw;
            y = rw;
            w = shadowSize;
            h = shadowSize;
            images.put(BOTTOM_RIGHT, getSubImage(targetImage, x, y, w, h));
            x = rw;
            y = cornerSize + 1;
            w = shadowSize;
            h = 1;
            images.put(RIGHT, getSubImage(targetImage, x, y, w, h));
            x = rw;
            y = 1;
            w = shadowSize;
            h = shadowSize;
            images.put(TOP_RIGHT, getSubImage(targetImage, x, y, w, h));
            x = shadowSize;
            y = 1;
            w = 1;
            h = shadowSize;
            images.put(TOP, getSubImage(targetImage, x, y, w, h));

            image.flush();

            CACHE.put(new Integer(shadowSize), images);
        }
        return images;
    }
