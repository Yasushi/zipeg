...
void ReadArchiverInfoList(CObjectVector<CArchiverInfo> &archivers)
{
  ...
  #ifdef FORMAT_ZIP
  {
    ...
    item.Extensions.Add(CArchiverExtInfo(L"zap"));
    item.Extensions.Add(CArchiverExtInfo(L"zpg"));
    item.Extensions.Add(CArchiverExtInfo(L"cbr"));
    item.Extensions.Add(CArchiverExtInfo(L"cbz"));
    item.Extensions.Add(CArchiverExtInfo(L"ear"));
    item.Extensions.Add(CArchiverExtInfo(L"war"));
    #ifndef _SFX
  ...
  #ifdef FORMAT_RAR
  {
    CArchiverInfo item;
    item.Name = L"Rar";
    item.Extensions.Add(CArchiverExtInfo(L"rar"));
    archivers.Add(item);
  }
  #endif
  ...
  #ifdef FORMAT_LZH
  {
    CArchiverInfo item;
    item.Name = L"Lzh";
    item.Extensions.Add(CArchiverExtInfo(L"lzh"));
    archivers.Add(item);
  }
  #endif
  ...
  #ifdef FORMAT_CHM
  {
    CArchiverInfo item;
    item.Name = L"Chm";
    item.Extensions.Add(CArchiverExtInfo(L"chm"));
    archivers.Add(item);
  }
  #endif
  ...
  #ifdef FORMAT_ISO
  {
    CArchiverInfo item;
    item.Name = L"Iso";
    item.Extensions.Add(CArchiverExtInfo(L"iso"));
    archivers.Add(item);
  }
  #endif
  ...
  #ifdef FORMAT_NSIS
  {
    CArchiverInfo item;
    item.Name = L"Nsis";
    item.Extensions.Add(CArchiverExtInfo(L"nsis"));
    archivers.Add(item);
  }
  #endif
