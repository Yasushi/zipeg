...
#include "../../Compress/Rar20/Rar20Decoder.h"
#include "../../Compress/Rar29/Rar29Decoder.h"
  ...
  try
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (result == S_FALSE)
          break;
        if (result != S_OK && _archiveInfo.IsEncrypted()) {
        ...
        */
        ...
        if (m == methodItems.Size())
        {
          ...
          if (item.UnPackVersion < 20) {
            mi.Coder = new NCompress::NRar15::CDecoder();
          }
          else if (item.UnPackVersion < 29) {
            mi.Coder = new NCompress::NRar20::CDecoder();
          }
          else {
            mi.Coder = new NCompress::NRar29::CDecoder();
          }
#else
          Byte myID;
          if (item.UnPackVersion < 20) {
